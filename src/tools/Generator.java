...
public class Generator {
	...
	static TwoPlusTwo rankEngine; // helper class for determining hand rank/strength

	public static void main(String[] args) throws IOException {
		rankEngine = new TwoPlusTwo(); // load lookup table for hand ranks
		
		// example
		System.out.println(getPreFlopOdds(stringToInt("Ks"), stringToInt("Kh"), stringToInt("Ad"))); // chances of winning preflop with three hole cards
	}
	
	// helper function for generating card combinations -> removes cards from a list of possible cards
	private static Integer[] getNewCards(int[] toRemove, int[] original) {
	...
	public static int stringToInt(String card) {
	...
	public static boolean[] findDiscard(int holeCardA, int holeCardB, int holeCardC, int boardCardA, int boardCardB, int boardCardC) {
		long ABRank = 0;
		long BCRank = 0;
		long ACRank = 0;
	...
	public static double[] getDiscardOdds(int holeCardA, int holeCardB, int holeCardC) {
		long aCount = 0;
		long bCount = 0;
		long cCount = 0;
	...
	public static double getPreFlopDiscardOdds(int holeCardA, int holeCardB, int discardCard) throws IOException {
		long wins = 0;
		long gameCount = 0;
	...
	private static double getPreFlopOdds(int holeCardA, int holeCardB, int holeCardC) throws IOException {
